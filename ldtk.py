...
class FieldDefinition:
    ...
    def from_dict(obj: Any) -> "FieldDefinition":
        ...
        editor_display_color = from_union(
            [from_none, from_str], obj.get("editorDisplayColor")
        )
    ...
    def to_dict(self) -> dict:
        ...
        if self.editor_display_color is not None:
            result["editorDisplayColor"] = from_union(
                [from_none, from_str], self.editor_display_color
            )
...
class EntityDefinition:
    ...
    def from_dict(obj: Any) -> "EntityDefinition":
        ...
        uid = from_int(obj.get("uid"))
        ui_tile_rect = from_union(
            [from_none, TilesetRectangle.from_dict], obj.get("uiTileRect")
        )
    ...
    def to_dict(self) -> dict:
        ...
        if self.ui_tile_rect is not None:
            result["uiTileRect"] = from_union(
                [from_none, lambda x: to_class(TilesetRectangle, x)], self.ui_tile_rect
            )
...
class AutoLayerRuleDefinition:
    ...
    def from_dict(obj: Any) -> "AutoLayerRuleDefinition":
        ...
        tile_ids = from_union(
            [from_none, lambda x: from_list(from_int, x)], obj.get("tileIds")
        )
        ...
        tile_rects_ids = from_list(
            lambda x: from_list(from_int, x), obj.get("tileRectsIds")
        )
    ...
    def to_dict(self) -> dict:
        ...
        if self.tile_ids is not None:
            result["tileIds"] = from_union(
                [from_none, lambda x: from_list(from_int, x)], self.tile_ids
            )
        ...
        result["tileRectsIds"] = from_list(
            lambda x: from_list(from_int, x), self.tile_rects_ids
        )
...
class AutoLayerRuleGroup:
    ...
    def to_dict(self) -> dict:
        ...
        if self.icon is not None:
            result["icon"] = from_union(
                [from_none, lambda x: to_class(TilesetRectangle, x)], self.icon
            )
...
class IntGridValueGroupDefinition:
    ...
    def __init__(
        self, color: Optional[str], identifier: Optional[str], uid: int
    ) -> None:
        self.color = color
        self.identifier = identifier
        self.uid = uid
...
class LayerDefinition:
    ...
    **WARNING**: some layer *instances* might use a different tileset. So most of the time,
    ...
    def from_dict(obj: Any) -> "LayerDefinition":
        ...
        auto_tiles_killed_by_other_layer_uid = from_union(
            [from_none, from_int], obj.get("autoTilesKilledByOtherLayerUid")
        )
        ...
        int_grid_values_groups = from_list(
            IntGridValueGroupDefinition.from_dict, obj.get("intGridValuesGroups")
        )
    ...
    def to_dict(self) -> dict:
        ...
        if self.auto_tiles_killed_by_other_layer_uid is not None:
            result["autoTilesKilledByOtherLayerUid"] = from_union(
                [from_none, from_int], self.auto_tiles_killed_by_other_layer_uid
            )
        if self.biome_field_uid is not None:
            result["biomeFieldUid"] = from_union(
                [from_none, from_int], self.biome_field_uid
            )
        ...
        result["intGridValuesGroups"] = from_list(
            lambda x: to_class(IntGridValueGroupDefinition, x),
...
class LdtkTableOfContentEntry:
    ...
    def from_dict(obj: Any) -> "LdtkTableOfContentEntry":
        ...
        instances = from_union(
            [lambda x: from_list(ReferenceToAnEntityInstance.from_dict, x), from_none],
            obj.get("instances"),
        )
        instances_data = from_list(
            LdtkTocInstanceData.from_dict, obj.get("instancesData")
        )
    ...
    def to_dict(self) -> dict:
        ...
        if self.instances is not None:
            result["instances"] = from_union(
                [
                    lambda x: from_list(
                        lambda x: to_class(ReferenceToAnEntityInstance, x), x
                    ),
                    from_none,
                ],
                self.instances,
            )
        result["instancesData"] = from_list(
            lambda x: to_class(LdtkTocInstanceData, x), self.instances_data
        )
        return result
...
class ForcedRefs:
    ...
    def from_dict(obj: Any) -> "ForcedRefs":
        ...
        int_grid_value_group_def = from_union(
            [IntGridValueGroupDefinition.from_dict, from_none],
        ...
        toc_instance_data = from_union(
            [LdtkTocInstanceData.from_dict, from_none], obj.get("TocInstanceData")
        )
    ...
    def to_dict(self) -> dict:
        ...
        if self.int_grid_value_group_def is not None:
            result["IntGridValueGroupDef"] = from_union(
                [lambda x: to_class(IntGridValueGroupDefinition, x), from_none],
        ...
        if self.toc_instance_data is not None:
            result["TocInstanceData"] = from_union(
                [lambda x: to_class(LdtkTocInstanceData, x), from_none],
                self.toc_instance_data,
            )
